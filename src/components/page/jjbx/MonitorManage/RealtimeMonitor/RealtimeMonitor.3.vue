            ...
            <div v-show="isLeftPanelVisible" class="common-monitor-left">
                ...
                <div class="left-close">
                    <div class="left-search" style="padding-left: 20px;">
                        <label @click='seleRadio=0' :style="{color:seleRadio==0?'#4178d7':'#b3b9c8',background:seleRadio==0?'url(../../../../../static/img/jjbx/monitor/position/radio-select.jpg)  no-repeat left center':'url(../../../../../static/img/jjbx/monitor/position/radio-noselect.jpg)  no-repeat left center'}"><span>所有</span></label>
                        <label @click='seleRadio=1' :style="{color:seleRadio==1?'#4178d7':'#b3b9c8',background:seleRadio==1?'url(../../../../../static/img/jjbx/monitor/position/radio-select.jpg)  no-repeat left center':'url(../../../../../static/img/jjbx/monitor/position/radio-noselect.jpg)  no-repeat left center'}"><span>上线</span></label>
                        <label @click='seleRadio=2' :style="{color:seleRadio==2?'#4178d7':'#b3b9c8',background:seleRadio==2?'url(../../../../../static/img/jjbx/monitor/position/radio-select.jpg)  no-repeat left center':'url(../../../../../static/img/jjbx/monitor/position/radio-noselect.jpg)  no-repeat left center'}"><span>离线</span></label>
                    </div>
                </div>
                ...
                <div ref="carsList" style="width:auto;overflow-y:auto; overflow-x:hidden;background:#fff;font-size:12px;">
                    <el-tree ref="monDeptTree" :data="data2" show-checkbox node-key="id" :default-expanded-keys="[1,2]"
                ...
                <div class="bottom"  >
                    ...
                    <div v-show="!startLo" @click="startLo=!startLo" class="column">
                        <a title="开始监控"><i class="start">开始监控</i></a>
                    </div>
                    <div v-show="startLo" @click="startLo=!startLo" class="column">
                        <a title="暂停监控"><i class="pause">暂停监控</i></a>
                    </div>
                    <div class="column">
                        <a title="取消监控"><i class="cancel">取消监控</i></a>
                    </div>
...
<script>
    ...
    export default {
        ...
        watch: {
            filterText(val) {
                this.$refs.monDeptTree.filter(val);
            }
        },
    };
...
<style>
    ...
    .common-monitor-left .bottom .column{
        float: left;margin: 0 10px;line-height:50px;
    }
