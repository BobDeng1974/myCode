...
<template>
    ...
    <div class="common-supercargo-body">
        <div style="padding-left:10px;height:22px;padding-top:8px;border-bottom:1px solid rgba(232,238,243,1);box-shadow:0px 2px 6px 0px rgba(47,149,244,0.13);">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>押运员档案</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="common-supercargo-formbox">
            <div class="common-supercargo-handlebox">
                <form :model="ruleForm" ref="ruleForm">
                    姓名： <input  class="sys-common-input" placeholder="请输入姓名" v-model.trim="ruleForm.personName">
                    押运证号： <input class="sys-common-input" placeholder="请输入押运证号" v-model.trim="ruleForm.credentNum">
        ...
        <div class="common-supercargo-menu">
        ...
        <div class="common-supercargo-table" v-loading="deptLoad">
            <el-table id="out-table" :data="tableData" :highlight-current-row="true" :stripe="true" :header-cell-style="{background:'rgba(238,245,251,1)'}"
                ...
                <el-table-column prop="credentNum" align="left" label="押运证号"  :show-overflow-tooltip="true">
                </el-table-column>
                <!-- <el-table-column prop="carsupercargoType" align="center" label="准驾车型" width="100">
                </el-table-column> -->
    ...
    export default {
        ...
        methods: {
            ...
            goDetail(index, row) {
                let _this = this;
                _this.$router.push({
                    // path: "/jjbx/SysManage/VehicleManage/vehicle/supercargoDetails",
                    name:'sm_supercargo_supercargoDetails',
            ...
            getData(){
                ...
                let  param = {
                        ...
                        orgname: _this.ruleForm.orgname[_this.ruleForm.orgname.length-1],
                };
                console.log(param);
            ...
            handleEdit(index, row){
                ...
                _this.$router.push({
                    ...
                    name:'sm_supercargo_supercargoEdit',
                    params: {id:_this.tableData[row.index].id}
                });
            },
            goAdd(){
                let _this = this; 
                _this.$router.push({name:'sm_supercargo_addsupercargo'});
            ...
            deleteRow(idx) {
                ...
                ajax.get(_this.global_.apiUrlJj + "/post/delete-person?id=" + _this.idx2)
                    .then(function (res) {
                        console.log(res);
            ...
            exportExcel () {
                ...
                try {
                    FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '押运员档案表.xlsx')
...
<style>
    ...
    /*定义滚动条的轨道颜色、内阴影及圆角*/
    .common-supercargo-table ::-webkit-scrollbar-track { 
        background-color: #E7EAEE !important; 
    }

    /*定义滑块颜色、内阴影及圆角*/
    .common-supercargo-table ::-webkit-scrollbar-thumb {
    ...
    /*定义两端按钮的样式*/
    .common-supercargo-table ::-webkit-scrollbar-button {
        background-color: #E7EAEE !important;
    }

    /*定义右下角汇合处的样式*/
    .common-supercargo-table ::-webkit-scrollbar-corner {
        background:#E7EAEE !important;
    }

    /* 整体布局 */
    .common-supercargo-body{height:calc( 100% - 111px )!important;
    }
    /* 表单整体背景 */
    .common-supercargo-formbox{
        width:100%;
    ...
    /* 操作按钮整体布局 */
    .common-supercargo-menu{height:50px;width:99.2%;background-color:#FFFFFF;border:none;}
    /* 按钮左对齐 */
    ...
    .common-supercargo-menu .el-button-text{ 
    ...
    .common-supercargo-menu .el-button-text button:nth-of-type(1),.common-supercargo-menu button:nth-of-type(2){
        width: 73px;
    }
    .common-supercargo-menu .el-button-text button:nth-of-type(3){
        width: 150px;
    }
    .common-supercargo-menu .el-button-text button:nth-of-type(4){
        width: 105px;
    }
    /* 按钮图标设置 */
    .common-supercargo-menu .el-button-text .img-3{display:inline-block;width:13px;height:12px;margin-right: 5px;position: relative;top: 1px;}
    .common-supercargo-body .el-table__body {
        /* margin-top: 10px; */
        border-radius: 4px !important;
    }

    .common-supercargo-body .el-table__body tr {
        height: 35px !important;
    }
    .common-supercargo-table .el-table{width: 100% !important;border:1px solid rgba(237,241,245,1) !important;margin-left: 10px !important;}
    .common-supercargo-table .el-table td, .el-table th.is-leaf{
        border-right: 1px solid #ebeef5 !important;
    }
    .common-supercargo-body .el-table td,
    .el-table th {
        padding: 2px !important;
    }

    .common-supercargo-body .icon {
        width: 2em !important;
        height: 2em !important;
        color: #5eaee3 !important;
    }

    .common-supercargo-body .common-supercargo-handlebox {
        /* margin-bottom: 20px; */
    ...
    .common-supercargo-handlebox .common-supercargo-select{
        height:28px;width:133px;color:#B4BCCC;border-radius:4px;margin-right:12px;font-size:12px;
    }
    .common-supercargo-body .handle-select {
        width: 8.4% !important;
        height: 32px !important;
        margin: 0 8px !important;
    }

    .common-supercargo-body .handle-input {
        width: 280px !important;
        display: inline-block !important;
    }

    .common-supercargo-body .el-input--small .el-input__inner {
        height: 32px !important;
        line-height: 32px !important;
    }

    .common-supercargo-body .el-input__inner {
        box-shadow: 0px 0px 6px 0px rgba(25, 107, 255, 0.1) !important;
    }

    .common-supercargo-body .el-input--suffix .el-input__inner {
        padding-right: 10px !important;
    }

    .common-supercargo-body .el-table  { 
        color: #909090 !important;
    }
    .common-supercargo-body .el-table th>.cell {
    ...
    .common-supercargo-body .el-table .cell {
        font-size: 12px !important;
        font-family: PingFang-SC-Bold !important;   
    }

    .common-supercargo-body .el-table--enable-row-hover .el-table__body tr:hover>td {
        background: #2f95f4 !important;
        color: #fff;
    }

    .common-supercargo-body .el-table--striped .el-table__body tr.el-table__row--striped td {
        background: #f6f8f9 ;
    }
    .common-supercargo-table .img-1{width:11px;height:15px;vertical-align: middle;cursor:pointer;}
    .common-supercargo-table .img-2{margin-right:14px;}
    /* 查询按钮 */
    .common-supercargo-handlebox .button-info{
    ...
    .common-supercargo-menu .button-info-2{
    ...
    .common-supercargo-body .el-input__icon{
        line-height: 28px !important;
    }
    .common-supercargo-body .el-cascader{
        line-height: 28px !important;
    }
</style>
