    ...
    <div class="common-fleet-body">
        <div style="padding-left:10px;height:22px;padding-top:8px;border-bottom:1px solid rgba(232,238,243,1);box-shadow:0px 2px 6px 0px rgba(47,149,244,0.13);">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>车队档案</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="common-fleet-formbox">
            <div class="common-fleet-handlebox">
                <el-form :model="ruleForm" ref="ruleForm">
                    车队名称：<input class="sys-common-input" placeholder="请输入车队名称" v-model.trim="ruleForm.organName"> 
                    负责人姓名：<input class="sys-common-input" placeholder="请输入姓名" v-model.trim="ruleForm.leaderName"> 
                    <button type="button" class="button-info" @click="search();">查询</button>
                </el-form>

            </div>
        </div>
        <div class="common-fleet-menu">
        ...
        <div class="common-fleet-table" v-loading="deptLoad">
            <el-table id="out-table" :data="tableData" :highlight-current-row="true" :stripe="true" :header-cell-style="{background:'rgba(238,245,251,1)'}"
                ...
                <el-table-column prop="organName" align="left" label="车队名称" :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="count" align="left" label="车辆数" :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="leaderName" align="left" label="车队负责人"  :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="organContact" align="left" label="联系人"  :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="phone" align="left" label="电话" :show-overflow-tooltip="true">
                </el-table-column>
                <el-table-column prop="remark" align="left" label="备注" :show-overflow-tooltip="true">
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                ajax
                    ...
                    .then(function (res) {
                        ...
                        for (let i = 0; i < res.data.data.content.length; i++) {
                            var obj = {};
                            obj.organName = res.data.data.content[i].organName;
                            obj.leaderName = res.data.data.content[i].leaderName;
                            obj.organContact = res.data.data.content[i].organContact;
                            obj.phone = res.data.data.content[i].phone;
                            obj.remark = res.data.data.content[i].remark;
                            obj.count = res.data.data.content[i].count;
            ...
            goAdd() {
                let _this = this;
                _this.$router.push({ name: "sm_fleet_fleetAdd" });
            },
            // goDetail(index, row) {
            //     let _this = this;
            //     _this.$router.push({
            ...
            deleteRow(idx) {
                ...
                ajax.get(_this.global_.apiUrlJj + "/post/delete-car?id=" + _this.idx2)
                    .then(function (res) {
                        console.log(res);
...
<style>
    ...
    .common-fleet-table ::-webkit-scrollbar-track {
        background-color: #e7eaee !important;
    }

    /*定义滑块颜色、内阴影及圆角*/

    .common-fleet-table ::-webkit-scrollbar-thumb {
    ...
    .common-fleet-table ::-webkit-scrollbar-button {
        background-color: #e7eaee !important;
    }

    /*定义右下角汇合处的样式*/

    .common-fleet-table ::-webkit-scrollbar-corner {
        background: #e7eaee !important;
    }
    ...
    .common-fleet-menu .el-button-text {
    ...
    .common-fleet-menu .el-button-text button:nth-of-type(1),
    .common-fleet-menu button:nth-of-type(2) {
        width: 73px;
    }

    .common-fleet-menu .el-button-text button:nth-of-type(3) {
        width: 150px;
    }

    .common-fleet-menu .el-button-text button:nth-of-type(4) {
        width: 105px;
    }

    /* 按钮图标设置 */

    .common-fleet-menu .el-button-text .img-3 {
    ...
    .common-fleet-body .el-table__body {
        /* margin-top: 10px; */
        border-radius: 4px !important;
    }

    .common-fleet-body .el-table__body tr {
        height: 35px !important;
    }

    .common-fleet-table .el-table {
        width: 100% !important;
        border: 1px solid rgba(237, 241, 245, 1) !important;
    }

    .common-fleet-body .el-table td,
    .el-table th {
        padding: 2px !important;
    }

    .common-fleet-body .icon {
        width: 2em !important;
        height: 2em !important;
        color: #5eaee3 !important;
    }

    .common-fleet-body .common-fleet-handlebox {
        /* margin-bottom: 20px; */
    ...
    .common-fleet-body .handle-select {
        width: 8.4% !important;
        height: 32px !important;
        margin: 0 8px !important;
    }

    .common-fleet-body .handle-input {
        width: 280px !important;
        display: inline-block !important;
    }

    .common-fleet-body .el-input--small .el-input__inner {
        height: 32px !important;
        line-height: 32px !important;
    }

    .common-fleet-body .el-input__inner {
        box-shadow: 0px 0px 6px 0px rgba(25, 107, 255, 0.1) !important;
    }

    .common-fleet-body .el-input--suffix .el-input__inner {
        padding-right: 10px !important;
    }

    .common-fleet-body .el-table {
        color: #909090 !important;
    }

    .common-fleet-body .el-table th>.cell {
    ...
    .common-fleet-body .el-table .cell {
        font-size: 12px !important;
        font-family: PingFang-SC-Bold !important;
    }

    .common-fleet-body .el-table--enable-row-hover .el-table__body tr:hover>td {
        background: #2f95f4 !important;
        color: #fff;
    }

    .common-fleet-body .el-table--striped .el-table__body tr.el-table__row--striped td {
        background: #f6f8f9 ;
    }

    .common-fleet-table .img-1 {
        width: 11px;
        height: 15px;
    ...
    .common-fleet-table .img-2 {
        margin-right: 14px;
    }
    .common-fleet-body .el-table td, .el-table th.is-leaf{
        border-right: 1px solid #ebeef5 !important;
    }
    /* 查询按钮 */

    .common-fleet-handlebox .button-info {
        display: inline-block;
        width: 68px;
        height: 29px;
    ...
    .common-fleet-menu .button-info-2 {
        display: inline-block;
        height: 29px;
        background-color: #2f95f4;
        color: #fff;
    ...
    .common-fleet-handlebox .el-input__icon {
        line-height: 28px !important;
    }

    .common-fleet-handlebox .el-cascader .el-input,
    .el-cascader .el-input__inner {
      /*   height: 28px; */
    }
    .common-fleet-handlebox .el-select {
        /* display: block; */
        position: relative !important;
        width: 133px !important;
    }
    .common-fleet-body .el-input--suffix .el-input__inner{height: 28px !important;}
    .common-fleet-handlebox .el-form-item {
